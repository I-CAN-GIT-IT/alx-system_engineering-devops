...
1. Repetition Token #0 - The regular expression must match the given cases. - 
    File: `1-repetition_token_0.rb`.
2. Repetition Token #1 - The regular expression must match the given cases. - 
    File: `2-repetition_token_1.rb`.
3. Repetition Token #2 - The regular expression must match the given cases. - 
    File: `3-repetition_token_2.rb`.
4. Repetition Token #3 - The regular expression must match the given cases. - 
...
7. OMG WHY ARE YOU SHOUTING? - TThe regular expression must be only matching: capital letters. - 
